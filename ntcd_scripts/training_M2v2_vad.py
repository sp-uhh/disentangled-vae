...
from packages.models.models import DeepGenerativeModel_v2
...
model_name = 'ntcd_M2v2_VAD_nonorm_hdim_{:03d}_{:03d}_zdim_{:03d}_end_epoch_{:03d}'.format(h_dim[0], h_dim[1], z_dim, end_epoch)
...
def main():
    print('Create model')
    model = DeepGenerativeModel_v2([x_dim, y_dim, z_dim, h_dim], classifier)
