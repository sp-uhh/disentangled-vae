...
from packages.models.mcem import MCEM_M2v2
from packages.models.models import DeepGenerativeModel_v2, Classifier
...
if labels == 'vad_labels':
    model_name = 'ntcd_M2v2_VAD_nonorm_hdim_128_128_zdim_016_end_epoch_500/M2_epoch_232_vloss_401.72'
    x_dim = 513
    y_dim = 1
    z_dim = 16
    h_dim = [128, 128]
...
def main():
    ...
    model = DeepGenerativeModel_v2([x_dim, y_dim, z_dim, h_dim], None)
    model.load_state_dict(torch.load(model_path, map_location="cpu"))

    print('- Number of learnable parameters: {}'.format(count_parameters(model)))

    mcem = MCEM_M2v2(niter=niter,
