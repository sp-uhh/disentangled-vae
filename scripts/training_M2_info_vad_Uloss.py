...
# model_name = 'ntcd_M2_info_VAD_Uloss_Lenc_aux_v3_alpha_0.0_beta_10.0_gamma_10.0_yhatsoft_nonorm_hdim_{:03d}_{:03d}_zdim_{:03d}_end_epoch_{:03d}'.format(h_dim[0], h_dim[1], z_dim, end_epoch)
# model_name = 'ntcd_M2_info_VAD_Uloss_Lenc_aux_v3_alpha_1.0_beta_10.0_gamma_10.0_yhatsoft_nonorm_hdim_{:03d}_{:03d}_zdim_{:03d}_end_epoch_{:03d}'.format(h_dim[0], h_dim[1], z_dim, end_epoch)
# model_name = 'ntcd_M2_info_VAD_Uloss_Lenc_aux_v3_alpha_10.0_beta_10.0_gamma_10.0_yhatsoft_nonorm_hdim_{:03d}_{:03d}_zdim_{:03d}_end_epoch_{:03d}'.format(h_dim[0], h_dim[1], z_dim, end_epoch)
# model_name = 'ntcd_M2_info_VAD_Uloss_Lenc_aux_v3_alpha_10.0_beta_10.0_gamma_1.0_yhatsoft_nonorm_hdim_{:03d}_{:03d}_zdim_{:03d}_end_epoch_{:03d}'.format(h_dim[0], h_dim[1], z_dim, end_epoch)
# model_name = 'ntcd_M2_info_VAD_Uloss_Lenc_aux_v3_alpha_10.0_beta_30.0_gamma_1.0_yhatsoft_nonorm_hdim_{:03d}_{:03d}_zdim_{:03d}_end_epoch_{:03d}'.format(h_dim[0], h_dim[1], z_dim, end_epoch)
# model_name = 'ntcd_M2_info_VAD_Uloss_Lenc_aux_v3_alpha_10.0_beta_30.0_gamma_10.0_yhatsoft_nonorm_hdim_{:03d}_{:03d}_zdim_{:03d}_end_epoch_{:03d}'.format(h_dim[0], h_dim[1], z_dim, end_epoch)
model_name = 'ntcd_M2_info_VAD_Uloss_Lenc_aux_v3_alpha_10.0_beta_40.0_gamma_10.0_yhatsoft_nonorm_hdim_{:03d}_{:03d}_zdim_{:03d}_end_epoch_{:03d}'.format(h_dim[0], h_dim[1], z_dim, end_epoch)
